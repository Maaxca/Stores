...
class EditStoreFragment : Fragment() {
    ...
    private fun loadImage(url:String){
        if(URLUtil.isValidUrl(url)){
            ...
            mBinding.tilPhotoUrl.error=getString(R.string.helper_url)
        }
    }
                    ...
                    doAsync {
                        ...
                        uiThread {
                            if(mIsEditMode){
                                ...
                                Snackbar.make(mBinding.root,R.string.edit_store_message_update_success,
    ...
    private fun validateFields(vararg textFields:TextInputLayout):Boolean{
        ...
        if(!isValid) Snackbar.make(mBinding.root,R.string.edit_store_title_valid,Snackbar.LENGTH_SHORT).show()
